...
public class ShortUrlService {
    ...
    public ShortUrlDto createShortUrl(CreateShortUrlCmd cmd) {
        if (properties.validateOriginalUrl()) {
            ...
            if (!urlExists) throw new RuntimeException("Invalid URL" + cmd.originalUrl());
        }
    ...
    private static final String CHARACTERS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz012345679";
